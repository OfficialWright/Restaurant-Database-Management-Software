...
public class menuSelect extends JFrame {
	menuPanelBuilder updatePanel;
	menuPanelBuilder searchPanel;
	JPanel buttonPanel;
	...
	public menuSelect() {
		...
		setTitle("Select/Update/Delete Menu");
  
		// Specify an action for the close button
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
  
		// Create a panelBuilder object
		updatePanel = new menuPanelBuilder("Update Menu");
		searchPanel = new menuPanelBuilder("Search Menu");
	...
	private void buildListPanel() {
		try {
			...
			ResultSet info = tableManager.selectMenu("", "");
						...
						// Check to make sure table is not being reloaded
							if (ourTable.getSelectedRow() >= 0) {
								...
								try {
									...
									updateInfo = tableManager.selectUpdateMenu(selectedValue);
	...
	private class SubmitButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				updater.updateMenu(name, price, selValue);
	...
	private class SearchButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				tableManager getInfo = new tableManager();
				// This creates a blank search of the table
				searchInfo = tableManager.selectMenu(name, price);
			} catch (SQLException e1) {
				e1.printStackTrace();
			}
	...
	private class ClearButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				tableManager getInfo = new tableManager();
				// This creates a blank search of the table
				searchInfo = tableManager.selectMenu("", "");
			} catch (SQLException e1) {
				e1.printStackTrace();
			}
			// Resets the table to the search criteria given above
