...
public class orderInsert extends JFrame {
	...
	public orderInsert() {
	    ...
	    infoPanel = new orderPanelBuilder("Insert Order");
	...
	private class SubmitButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			try {
				...
				String price = infoPanel.getPrice();
				String table = infoPanel.getTable();
				String user = infoPanel.getUser();
				
				// Create a tableManager object
				tableManager tManager = new tableManager();
				
				// Insert the record
				tManager.insertOrder(quantity, price, table, user, product);
